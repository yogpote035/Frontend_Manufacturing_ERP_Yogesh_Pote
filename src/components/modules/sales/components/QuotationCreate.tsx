...
const QuotationCreate: React.FC = () => {
    ...
    const handleSubmit = () => {
        ...
        if (lineItems.some(item => !item.product)) newErrors.lineItems = 'Please add at least one product';
                ...
                <div className="space-y-6">
                    ...
                    {activeSection === 'items' && (
                        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                                            ...
                                            <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                                                <td className="p-4">
                                                    <input
                                                        ...
                                                        className="w-48 px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#005d52]"
                            ...
                            {errors.lineItems && (
                                <div className="p-4 text-red-500 text-sm">{errors.lineItems}</div>
                            )}
                        </div>
                    )}
                            ...
                            <div className="p-6 space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <FormField
                                        ...
                                        type="select"
                                        options={['Net 15', 'Net 30', 'Net 45', 'Net 60', 'Due on Receipt', '50% Advance', '100% Advance']}
                                    />
                                    <FormField
                                        label="Delivery Terms"
                                        value={formData.deliveryTerms}
                                        onChange={(val) => setFormData({...formData, deliveryTerms: val})}
                                        type="select"
                            ...
                            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-between py-2">
                                        ...
                                        <span className="font-medium">₹{totals.taxableValue.toLocaleString('en-IN', { minimumFractionDigits: 2 })}</span>
                                    </div>
                                    <div className="flex justify-between py-2">
                                        <span>Total Tax</span>
                                    ...
                                    <div className="border-t-2 border-gray-200 pt-4 mt-2">
                                        ...
                                        <div className="text-right text-xs text-gray-400 mt-1">
                                            {formData.currency === 'INR' ? 'Inclusive of all taxes' : 'Exclusive of taxes'}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
                                ...
                                <div className="space-y-4">
                                    <FormField
                                        ...
                                        onChange={(val) => setFormData({...formData, quotationDate: val})}
                                    />
                                    <FormField
                                        label="Valid Until"
                                        type="date"
                                    ...
                                    <FormField
                                        ...
                                        onChange={(val) => setFormData({...formData, referenceNumber: val})}
    ...
    <div className="flex flex-col gap-1.5">
        ...
        {type === 'select' && options ? (
            <select
                ...
                className="w-full px-3 py-2 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#005d52] focus:border-transparent text-sm"
            >
                {options.map(opt => (
            ...
            <textarea
                ...
                className="w-full px-3 py-2 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#005d52] focus:border-transparent text-sm resize-none"
            />
        ) : (
            <input
                type={type}
                ...
                onChange={(e) => onChange(e.target.value)}
                placeholder={placeholder}
                className={`w-full px-3 py-2 bg-white border rounded-xl focus:outline-none focus:ring-2 focus:ring-[#005d52] focus:border-transparent text-sm ${
